...
export class ThemeService {
  ...
  private applyTheme(themeName: ThemeName): void {
    ...
    // === GRADIENTES ===
    root.style.setProperty('--gradient', `linear-gradient(135deg, ${config.colors.primary} 0%, ${config.colors.accent} 100%)`);
    root.style.setProperty('--gradient-primary', `linear-gradient(135deg, ${config.colors.primary} 0%, ${config.colors.accent} 100%)`);
    root.style.setProperty('--gradient-secondary', `linear-gradient(135deg, ${config.colors.secondary} 0%, ${config.colors.accent} 100%)`);
    root.style.setProperty('--gradient-text', `linear-gradient(to right, ${config.colors.secondary}, ${config.colors.accent})`);
