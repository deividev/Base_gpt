...
export const routes: Routes = [
  ...
  },
  {
    path: "users/:id",
    loadComponent: () =>
      import("./pages/users/user-detail.page").then((m) => m.UserDetailPage),
  },
  {
    path: "**",
    loadComponent: () =>
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "overview",
        loadComponent: () =>
          import("./pages/dashboard/overview.page").then((m) => m.OverviewPage),
      },
      {
        path: "analytics",
        loadComponent: () =>
          import("./pages/dashboard/analytics.page").then(
            (m) => m.AnalyticsPage,
          ),
      },
      {
        path: "settings",
        loadComponent: () =>
          import("./pages/dashboard/settings.page").then((m) => m.SettingsPage),
      },
    ],
  },
];
